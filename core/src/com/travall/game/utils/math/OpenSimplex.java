...
/**
 * K.jpg's original OpenSimplex Noise DigitalShadow's optimized implementation,
 * https://gist.github.com/digitalshadow/134a3a02b67cecd72181/ with updated
 * gradient sets (Dec 2019, Feb 2020)
 */
public class OpenSimplex {
	...
	static {
		...
		int[][] base2D = new int[][] { new int[] { 1, 1, 0, 1, 0, 1, 0, 0, 0 },
				new int[] { 1, 1, 0, 1, 0, 1, 2, 1, 1 } };
		int[] p2D = new int[] { 0, 0, 1, -1, 0, 0, -1, 1, 0, 2, 1, 1, 1, 2, 2, 0, 1, 2, 0, 2, 1, 0, 0, 0 };
		int[] lookupPairs2D = new int[] { 0, 1, 1, 0, 4, 1, 17, 0, 20, 2, 21, 2, 22, 5, 23, 5, 26, 4, 39, 3, 42, 4, 43,
				3 };
