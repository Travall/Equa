...
public class CactusModel implements IBlockModel {
	...
	public CactusModel(Block block, BlockTextures textures) {
		...
		quad1 = new QuadNode();
		quad1.v1.setPos(1f, 1, 0f);
		quad1.v2.setPos(0f, 1, 0f);
		quad1.v3.setPos(0f, 1, 1f);
		quad1.v4.setPos(1f, 1, 1f);
		quad1.face = Facing.UP;
		quad1.region.setRegion(textures.top);

		quad2 = new QuadNode();
		quad2.v1.setPos(0f, 0, 0f);
		quad2.v2.setPos(1f, 0, 0f);
		quad2.v3.setPos(1f, 0, 1f);
		quad2.v4.setPos(0f, 0, 1f);
		quad2.face = Facing.DOWN;
		quad2.region.setRegion(textures.bottom);

		quad3 = new QuadNode();
		quad3.v1.setPos(1f, 0, 0.875f);
		quad3.v2.setPos(1f, 1, 0.875f);
		quad3.v3.setPos(0f, 1, 0.875f);
		quad3.v4.setPos(0f, 0, 0.875f);
		quad3.face = Facing.NORTH;
		quad3.region.setRegion(textures.south);

		quad4 = new QuadNode();
		quad4.v1.setPos(0.875f, 0, 0f);
		quad4.v2.setPos(0.875f, 1, 0f);
		quad4.v3.setPos(0.875f, 1, 1f);
		quad4.v4.setPos(0.875f, 0, 1f);
		quad4.face = Facing.EAST;
		quad4.region.setRegion(textures.south);

		quad5 = new QuadNode();
		quad5.v1.setPos(0f, 0, 0.125f);
		quad5.v2.setPos(0f, 1, 0.125f);
		quad5.v3.setPos(1f, 1, 0.125f);
		quad5.v4.setPos(1f, 0, 0.125f);
		quad5.face = Facing.SOUTH;
		quad5.region.setRegion(textures.south);

		quad6 = new QuadNode();
		quad6.v1.setPos(0.125f, 0, 1f);
		quad6.v2.setPos(0.125f, 1, 1f);
		quad6.v3.setPos(0.125f, 1, 0f);
		quad6.v4.setPos(0.125f, 0, 0f);
