...
//     |       |
//     v4-----v1
	public void buildCube(Block block, BlockPos pos, boolean up, boolean down, boolean south,
						  boolean west, boolean north, boolean east) {
		...
		if (up) { // facing up Y+
			...
			setAmb(1f);
			v1.vertAO(world.blockExists(x+1, y1, z), world.blockExists(x, y1, z-1), world.blockExists(x+1, y1, z-1));
			v2.vertAO(world.blockExists(x-1, y1, z), world.blockExists(x, y1, z-1), world.blockExists(x-1, y1, z-1));
			v3.vertAO(world.blockExists(x-1, y1, z), world.blockExists(x, y1, z+1), world.blockExists(x-1, y1, z+1));
			v4.vertAO(world.blockExists(x+1, y1, z), world.blockExists(x, y1, z+1), world.blockExists(x+1, y1, z+1));

			final int center = world.getLight(x, y1, z);
			v1.smoothLight(center, world.getLight(x+1, y1, z), world.getLight(x, y1, z-1), world.getLight(x+1, y1, z-1));
			v2.smoothLight(center, world.getLight(x-1, y1, z), world.getLight(x, y1, z-1), world.getLight(x-1, y1, z-1));
			v3.smoothLight(center, world.getLight(x-1, y1, z), world.getLight(x, y1, z+1), world.getLight(x-1, y1, z+1));
			v4.smoothLight(center, world.getLight(x+1, y1, z), world.getLight(x, y1, z+1), world.getLight(x+1, y1, z+1));

			rect(textures.top);
		}
		if (down) { // facing down Y-
			final int y1 = y-1;
			temp = pos.y;
		...
		if (south) { // facing south Z-
			...
			setAmb(1);
			v1.vertAO(world.blockExists(x, y-1, z1), world.blockExists(x-1, y, z1), world.blockExists(x-1, y-1, z1));
			v2.vertAO(world.blockExists(x, y+1, z1), world.blockExists(x-1, y, z1), world.blockExists(x-1, y+1, z1));
			v3.vertAO(world.blockExists(x, y+1, z1), world.blockExists(x+1, y, z1), world.blockExists(x+1, y+1, z1));
			v4.vertAO(world.blockExists(x, y-1, z1), world.blockExists(x+1, y, z1), world.blockExists(x+1, y-1, z1));

			final int center = world.getLight(x, y, z1);
			v1.smoothLight(center, world.getLight(x, y-1, z1), world.getLight(x-1, y, z1), world.getLight(x-1, y-1, z1));
			v2.smoothLight(center, world.getLight(x, y+1, z1), world.getLight(x-1, y, z1), world.getLight(x-1, y+1, z1));
			v3.smoothLight(center, world.getLight(x, y+1, z1), world.getLight(x+1, y, z1), world.getLight(x+1, y+1, z1));
			v4.smoothLight(center, world.getLight(x, y-1, z1), world.getLight(x+1, y, z1), world.getLight(x+1, y-1, z1));

			rect(textures.render1);
		}
		if (west) { // facing west X-
			final int x1 = x-1;
			temp = x;
			...
			setAmb(1);
			v1.vertAO(world.blockExists(x1, y-1, z), world.blockExists(x1, y, z+1), world.blockExists(x1, y-1, z+1));
			v2.vertAO(world.blockExists(x1, y+1, z), world.blockExists(x1, y, z+1), world.blockExists(x1, y+1, z+1));
			v3.vertAO(world.blockExists(x1, y+1, z), world.blockExists(x1, y, z-1), world.blockExists(x1, y+1, z-1));
			v4.vertAO(world.blockExists(x1, y-1, z), world.blockExists(x1, y, z-1), world.blockExists(x1, y-1, z-1));

			final int center = world.getLight(x1, y, z);
			v1.smoothLight(center, world.getLight(x1, y-1, z), world.getLight(x1, y, z+1), world.getLight(x1, y-1, z+1));
			v2.smoothLight(center, world.getLight(x1, y+1, z), world.getLight(x1, y, z+1), world.getLight(x1, y+1, z+1));
			v3.smoothLight(center, world.getLight(x1, y+1, z), world.getLight(x1, y, z-1), world.getLight(x1, y+1, z-1));
			v4.smoothLight(center, world.getLight(x1, y-1, z), world.getLight(x1, y, z-1), world.getLight(x1, y-1, z-1));

			rect(textures.render2);
		}
		if (north) { // facing north Z+
			final int z1 = z+1;
			temp = z1;
...
//		public float u, v; // Not needed.
		...
		public void smoothLight(int center, int side1, int side2, int corner) {
			...
			srcLit = (srcLightTotal>>>2) / LightUtil.lightScl;
		}
